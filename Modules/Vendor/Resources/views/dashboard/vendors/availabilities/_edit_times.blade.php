...
<div class="tab-pane fade in" id="availabilities">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="checkbox" class="make-switch" id="vendor_status_id" data-size="small" name="vendor_status_id"
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                @foreach (getDays() as $k => $day)
                    ...
                    @if (isset(
                            $vendor->workTimes()->where('day_code', $k)->first()->is_full_day) &&
                            $vendor->workTimes()->where('day_code', $k)->first()->is_full_day == 0)
