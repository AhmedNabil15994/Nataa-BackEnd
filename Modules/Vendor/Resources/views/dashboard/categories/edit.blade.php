        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      ...
                      action="{{route('dashboard.vendor_categories.update',$category->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                ...
                                                <li>
                                                    <a href="#seo" data-toggle="tab">
                                                        {{ __('vendor::dashboard.categories.form.tabs.seo') }}
                                                    </a>
                                                </li>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in" id="seo">
                                    {{--                                    <h3 class="page-title">{{__('vendor::dashboard.categories.form.tabs.seo')}}</h3>--}}
                                    <div class="col-md-10">
                                        {{--  tab for lang --}}
                                        <ul class="nav nav-tabs">
                                            @foreach (config('translatable.locales') as $code)
                                        ...
                                        <div class="tab-content">
                                            ...
                                            @foreach (config('translatable.locales') as $code)
                                                <div id="first_{{$code}}"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{__('vendor::dashboard.categories.form.meta_keywords')}}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{__('vendor::dashboard.categories.form.meta_description')}}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
