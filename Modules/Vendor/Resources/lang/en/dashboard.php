...
return [
    ...
    'vendors' => [
        ...
        'validation' => [
            ...
            'section_id' => [
                'required' => 'Please select the sections of this vendor',
                'array' => 'Sections of this vendor should be in array type.',
                'exists' => 'Section of this vendor is not available now',
            ],
            'vendor_category_id' => [
        ...
        'form' => [
            "vendor_busy_status" => "Vendor Status ( Busy )",
        ],
    ],
    'delivery_charges' => [
        'create' => [
