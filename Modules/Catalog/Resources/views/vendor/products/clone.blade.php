...
@section('title', __('catalog::vendor.products.routes.clone'))
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('catalog::vendor.products.routes.clone') }}</a>
                    </li>
                </ul>
            </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    @include('core::vendor.shared.file_upload', [
                                                        'image' => $product->image,
                                                    ])
                                                    <input type="hidden" name="product_old_image"
                                                        value="{{ $product->image }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="price" class="form-control"
                                                    data-name="price" value="{{ $product->price }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                ...
                                <button type="button" class="btn btn-lg green load_variations">
                                    ...
                                    {{__('catalog::vendor.products.form.add_variations')}}
                                        ...
                                        <div style="display: none" id="result-add-option">
                                            <h2 class="text-center">{{ __('catalog::vendor.products.form.new_add') }}
                                            </h2>
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-btn">
                                                                    <span class="btn btn-default btn-file-upload">
                                                                        ...
                                                                        <input type="file"
                                                                            name="images[{{ $img->id }}]"
                                                                            onchange="readGalleryURL(this, {{ $k }});">

                                                                        <input type="hidden"
                                                                            id="hidden-images-{{ $k }}"
                                                                            name="hidden_images[{{ $img->id }}]"
                                                                            value="{{ $img->image }}">
                                                                    </span>
                                                                </span>
                                                                <input type="text"
                                                            ...
                                                            <span class="input-group-btn">
                                                                <span class="btn btn-default btn-file-upload">
                                                                    ...
                                                                    <input type="file" name="images[]"
                                                                        onchange="readGalleryURL(this, 0);">
                                                                </span>
                                                            </span>
        ...
        function addMoreImages() {
            ...
            <div id="prd-image-${rowCount}" class="prd-image-section">
                <div class="input-group">
                    <span class="input-group-btn">
                         <span class="btn btn-default btn-file-upload">
                         {{ __('catalog::dashboard.products.form.browse_image') }}<input type="file" name="images[${rowCount}]" onchange="readGalleryURL(this, ${rowCount});">
                         </span>
                    </span>
