<div class="tab-pane fade" id="payment_gateway">
                    ...
                    <div class="mt-radio-inline">
                        <label class="mt-radio mt-radio-outline">
                            ...
                            <input type="radio" name="payment_gateway[upayment][payment_mode]" value="test_mode"
                                @if (config('setting.payment_gateway.upayment.payment_mode') != 'live_mode') checked @endif>
                            <span></span>
                        </label>
                        <label class="mt-radio mt-radio-outline">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <div class="mt-radio-inline">
                        <label class="mt-radio mt-radio-outline">
                            {{ __('setting::dashboard.settings.form.payment_gateway.payment_mode.test_mode') }}
                            <input type="radio" name="payment_gateway[myFatoorah][payment_mode]" value="test_mode"
                                @if (config('setting.payment_gateway.myFatoorah.payment_mode') != 'live_mode') checked @endif>
                            <span></span>
                        </label>
                        <label class="mt-radio mt-radio-outline">
                            {{ __('setting::dashboard.settings.form.payment_gateway.payment_mode.live_mode') }}
                            <input type="radio" name="payment_gateway[myFatoorah][payment_mode]" value="live_mode"
                                @if (config('setting.payment_gateway.myFatoorah.payment_mode') == 'live_mode') checked @endif>
                            <span></span>
                        </label>
                    </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-4">
            ...
            <h4> {{ __('setting::dashboard.settings.form.payment_gateway.payment_types.title') }}</h4>
            <div class="form-group">
                <label class="checkbox-inline">
                    <input type="checkbox" name="other[supported_payments][]"
                        @if (in_array('cash', config('setting.other.supported_payments') ?? [])) checked @endif value="cash">
                    {{ __('setting::dashboard.settings.form.payment_gateway.payment_types.cash') }}
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" name="other[supported_payments][]"
                        @if (in_array('online', config('setting.other.supported_payments') ?? [])) checked @endif value="online">
