<div class="tab-pane fade" id="other">
        ...
        <div class="col-md-9">
            <select name="default_vendor" class="form-control select2">
                ...
                <option value="{{ $vendor['id'] }}"
                    {{( config('setting.default_vendor') == $vendor->id) ? ' selected="" ' : ''}}>
    ...
    <div class="col-md-9">
        <div class="mt-radio-inline">
            <label class="mt-radio mt-radio-outline">
                {{ __('setting::dashboard.settings.form.yes') }}
                <input type="radio" name="other[enable_subscriptions]" value="1" @if
                    (config('setting.other.enable_subscriptions')==1) checked @endif>
                <span></span>
            </label>
            <label class="mt-radio mt-radio-outline">
                {{ __('setting::dashboard.settings.form.no') }}
                <input type="radio" name="other[enable_subscriptions]" value="0" @if
                    (config('setting.other.enable_subscriptions')==0) checked @endif>
                <span></span>
            </label>
        </div>
    </div>
