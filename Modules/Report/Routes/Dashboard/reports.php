...
Route::group(["namespace" => "Dashboard"], function () {
    ...
    Route::group(['prefix' => 'drivers-reports'], function () {

        Route::get('/', 'ReportController@drivers')
            ->name('dashboard.reports.drivers')
            ->middleware(['permission:show_drivers_reports']);

        Route::get('datatable', 'ReportController@driversDataTable')
            ->name('dashboard.reports.drivers_datatable')
            ->middleware(['permission:show_drivers_reports']);
