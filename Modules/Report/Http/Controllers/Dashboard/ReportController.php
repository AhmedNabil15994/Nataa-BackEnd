...
use Modules\Report\Transformers\Dashboard\DriverReportResource;
...
class ReportController extends Controller
{
    ...
    {
        return view('report::dashboard.reports.drivers');
    }
...
//        $datatable['data'] = ($datatable['data']);
    ...
    public function driversDataTable(Request $request)
    {
        $datatable = DataTable::drawTable($request, $this->repo->drivers($request));
        $datatable['data'] = DriverReportResource::collection($datatable['data']);
        return Response()->json($datatable);
    }
