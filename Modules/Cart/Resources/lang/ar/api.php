...
return [
    'cart' => [
        'product' => [
            ...
            'select_single_addons' => 'من فضلك اختر من الاضافات الفردية للمنتج للإضافة',
            'product_times' => 'عفوا ,هذا المنتج غير متاح حالياً ,يرجي المحاولة مرة اخري',
        ],
    ],
    'validations' => [
        'cart' => [
        ...
        'addons' => [
            ...
            'options' => [
                'required' => 'اختر من إختيارات الإضافة',
            ],
        ],
    ],
];
