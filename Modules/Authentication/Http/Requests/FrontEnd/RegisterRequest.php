...
//            'mobile' => ['required', 'unique:users,mobile', 'max:8'],
    ...
    public function messages()
    {
        $v = [
            ...
            'g-recaptcha-response.required' => __('authentication::frontend.register.validation.g-recaptcha-response.required'),
            'g-recaptcha-response.captcha' => __('authentication::frontend.register.validation.g-recaptcha-response.captcha'),
        ];
