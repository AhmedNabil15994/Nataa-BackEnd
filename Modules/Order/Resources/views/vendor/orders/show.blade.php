                                                ...
                                                <table class="table table-hover">
                                                                    ...
                                                                    <td class="text-left sbold">
                                                                        <a
                                                                            ...
                                                                            @if ($product->variant->product->vendor)
                                                                                {{ $product->variant->product->vendor->translate(locale())->title }}
                                                                                <br>
                                                                            @endif
                                                                    ...
                                                                    <td class="notbold text-left">
                                                                        <a
                                                                            ...
                                                                            @if ($product->product->vendor)
                                                                                {{ $product->product->vendor->translate(locale())->title }}
                                                                                <br>
                                                                            @endif
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th></th>
                                                            <th class="text-left bold">
                                                                {{ ucfirst($order->transactions->method) }}</th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                                    ...
                                                    <select name="order_status" id="single" class="form-control"
                                                        ...
                                                        @foreach ($statuses as $status)
                                                            <option value="{{ $status->id }}"
                                                                 {{!in_array($status->flag,Modules\Order\Enum\Order::VENDOR_ORDERS_CAN_UPDATE_TO) ? "disabled" : ''}}
                                                                 class="{{!in_array($status->flag,Modules\Order\Enum\Order::VENDOR_ORDERS_CAN_UPDATE_TO) ? "disable-option-selector" : ''}} {{ $order->order_status_id == $status->id ? 'selected-option-selector' : '' }}"
